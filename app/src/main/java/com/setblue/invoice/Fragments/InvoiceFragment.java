...
public class InvoiceFragment extends Fragment implements DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (from == null) {
            ...
            ((ClientDetailActivity) getActivity()).title.setText("Create Invoice");
            ((ClientDetailActivity) getActivity()).editClient.setVisibility(View.GONE);
            lbl.setVisibility(View.GONE);
            clientDetail();
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
                        ...
                        if (from == null) {
                            ...
                            getFragmentManager().popBackStack();
                            ((ClientDetailActivity) getActivity()).title.setText("Client Details");
                            ((ClientDetailActivity) getActivity()).editClient.setVisibility(View.VISIBLE);
