...
/**
 * Created by praful on 06-Mar-17.
 */

public class Apis {

    public static String STRING_SERVER_URL = "http://invoice.modelbuzz.in/MobileApi/";

    public static String Register = STRING_SERVER_URL+"Register?";
    public static String Login = STRING_SERVER_URL+"Login?";
    public static String AddClient = STRING_SERVER_URL+"AddClient?";
    ...
    public static String ForgotPassword = STRING_SERVER_URL+"ForgotPassword?";
    public static String ClientDetails = STRING_SERVER_URL+"ClientDetails?";
